...
def _render_markdown_split(
    ...
    *,
    ...
    lines += [
        ...
        f"RouteLLM / LMSYS quality bands · {_methodology_tail_text(measure_result)}_",
        "",
    ]
...
def _render_html_v2_split_body(
    ...
    *,
    ...
    foot += [
        ...
        f"&middot; RouteLLM / LMSYS quality bands &middot; {esc(_methodology_tail_text(measure_result))}</p>",
        '<p class="cta">'
